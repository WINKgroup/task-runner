...
webserver.app.get('/', (req, res) => res.sendFile(path.join(__dirname, './index.html')))
...
function setupRunners() {
    ...
    const runner1 = new TaskRunner({
        ...
        consoleLog: new ConsoleLog({ verbosity: LogLevel.DEBUG, prefix: 'TaskRunner1' })
    });
    ...
    const runner2 = new TaskRunner({
        ...
        consoleLog: new ConsoleLog({ verbosity: LogLevel.DEBUG, prefix: 'TaskRunner2' })
    });
